...
@ScriptConfiguration.List(
    [
        ...
        ScriptConfiguration(
            ...
            allowedValues = ["NONE", EDGEVILLE_GLORY, EDGEVILLE_MOUNTED_GLORY, FEROX_ENCLAVE_ROD, FEROX_ENCLAVE_JEWELLERY_BOX, CASTLE_WARS_ROD, CASTLE_WARS_JEWELLERY_BOX, LUNAR_
        ),
        ScriptConfiguration(
...
class Fighter : ATScript() {
    ...
    val npcTeleport by lazy { Teleport.forName(getOption("NpcTeleport")) }
