...
@ScriptManifest(name = "krul GiantMole", description = "Dharok that mole back in the ground", "Krulvis", version = "1.0.3", category = ScriptCategory.Combat, priv = true, scriptId = "8552ff64-5ae0-4be9-b94b-b580540d8a26")
