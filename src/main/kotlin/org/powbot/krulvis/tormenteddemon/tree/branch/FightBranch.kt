...
class ShouldDodgeProjectile(script: TormentedDemon) : Branch<TormentedDemon>(script, "ShouldDodgeProjectile?") {
	override val failedComponent: TreeComponent<TormentedDemon> = ShouldCastResurrect(script)
	override val successComponent: TreeComponent<TormentedDemon> = SimpleLeaf(script, "Dodge Rock") {
