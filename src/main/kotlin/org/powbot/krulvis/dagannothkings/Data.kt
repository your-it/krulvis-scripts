...
object Data {
    ...
    enum class King(
        ...
        Supreme(2854, Prayer.Effect.PROTECT_FROM_MISSILES, Prayer.Effect.PIETY, emptyList(), Tile.Nil, false),
        Rex(2854, Prayer.Effect.PROTECT_FROM_MELEE, Prayer.Effect.MYSTIC_MIGHT, emptyList(), Tile.Nil, true),
